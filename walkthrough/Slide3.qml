...
Component {
    ...
    Item {
        ...
        Image {
            ...
            source: Qt.resolvedUrl("../graphics/intro_image2.png")
        ...
        Label {
            id: body
            text: i18n.tr("See notes of a chord on a fretboard and press a button to play the chord.")
